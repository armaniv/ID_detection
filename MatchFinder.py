...
img2 = cv.imread('/home/vale/Scaricati/ita_drvid_2.jpg', 1)             # trainImage
...
print("Found %s match/es" % (len(good)))

if len(good) > MIN_MATCH_COUNT:                                         # the minimum accepted number of matches is 4
